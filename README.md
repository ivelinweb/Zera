...
cp .env.example .env
# Edit .env and set: NEXT_PUBLIC_ZAI_API_KEY=your_api_key_here
```
...
- **AI-Powered Security Analysis**: Analyze smart contracts for vulnerabilities using **Z.ai (GLM 5.1)** — advanced AI model for code analysis
...
- `utils/` - Utility functions and blockchain configuration
  ...
  - `mistralAI.ts` - AI integration with Z.ai (GLM 5.1) API
...
This project uses **Z.ai (GLM 5.1)** for all AI-powered features:
